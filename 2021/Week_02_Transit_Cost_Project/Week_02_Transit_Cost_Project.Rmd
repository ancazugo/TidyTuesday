---
title: "Week 2 - Transit Cost Project"
...
```{r by_country, warning = FALSE, message=FALSE}
df_country <- df %>%
    group_by(country) %>%
...
```{r rank, warning = FALSE, message=FALSE}
df_rank <- df_country %>%
...
```{r plot, warning = FALSE, message=FALSE, fig.show='hide'}
